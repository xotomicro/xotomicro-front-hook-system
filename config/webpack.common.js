...
module.exports = {
    ...
    plugins: getMicroFrontPluginsConfig({packageName: "xotomicro_front_hook_system", packageDependencies, HtmlWebpackPlugin, EnvironmentPlugin, ModuleFederationPlugin}),
}
